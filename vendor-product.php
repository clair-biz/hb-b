...
$vs_id= $user->vs_id;
$q="select product.prod_id,prod_img,prod_name,prod_desc,cs_name,mrp from product,cat_sub,product_price where product.prod_id=product_price.prod_id and cat_sub.cs_id=product.cs_id and product.is_active='Y' and product.vs_id=$vs_id";
...
?>
     ...
     <div class="container-fluid" style="margin-top: 40px;">
        ...
        <div class="card container-fluid product-content">
        </div>
        <div class="card container-fluid product-update-block">
        </div>
        </div>
