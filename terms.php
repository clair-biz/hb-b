<html>
    <head>
        <title> Homebiz365-- Terms and Conditions </title>
...
<?php require_once 'data.php';?>
    ...
    <h5 class="text-center"><b>Terms and Conditions</b></h5>
    <button type="button" onclick="window.top.close();" class="terms-btn btn red right" >Close</button>
    <object class="term-div" data='<?php echo $root."assets/terms.pdf"; ?>' 
        type='application/pdf' 
        width='100%' 
        height='70%'>
            <p>Your web browser doesn't have a PDF plugin.
                Instead you can <a href="<?php echo $root."assets/terms.pdf"; ?>">click here to
