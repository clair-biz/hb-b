...
?>
<div class="container-fluid head-block d-none d-sm-block navigation-bar" style="padding-left: 5% !important; padding-right: 5% !important; background: #009846;">
        <div class="row">
...
<?php           
    ...
    ?>">
        <ul class="navbar-nav">
    <li class="nav-item">
        <a class="nav-link float-right" href="<?php echo $root."About";?>" style="display: inline !important;">About Us</a>
      </li>
        </ul>
    </div>
    <div class="<?php 
    ...
    ?>">
        <ul class="navbar-nav">
    <li class="nav-item">
        <a class="nav-link float-right" href="<?php echo $root."Contact";?>" style="display: inline !important;">Contact Us</a>
      </li>
        </ul>
    </div>
        </div>
    ...
    <nav class="navbar navbar-expand-md navbar-light sticky-top  bg-white shadow " style="z-index: 1050 !important; padding-left: 5% !important; padding-right: 5% !important;">
  <!-- Brand -->
...
<?php
    ...
    <li class="nav-item focus no-hover">
          <a class="nav-link float-right" href="<?php echo $root."Cart"; ?>" style="display: inline !important; color: white;"><i class="fas fa-shopping-cart"></i> Cart <span class="cartdata"></span></a>
            ...
            if($user!="") { ?>
    <!-- Dropdown -->
    <li class="nav-item focus no-hover dropdown">
        <a class="nav-link float-right dropdown-toggle" 
           id="navbardrop" data-toggle="dropdown" style="display: inline !important; color: white;">
