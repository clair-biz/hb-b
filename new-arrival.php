...
<div class="card" style="border: none; margin-bottom: 30px; margin-top:30px;">
<!--
New Products
-->
<div class="card-body row" style="padding: 0px !important;">
    <div class="col-sm-12">
        <h5 class="page-header mx-5">
            <span style="border-bottom: 2px solid #e31e24;"><b>New Arrivals</b></span>
        </h5>
    </div>
      <!--hr style="border-color: #E31E24; color: #E31E24; border-width: 3px; border-top: #E31E24;" /-->
<section class="slider-new col-sm-12" style="margin-top: 3px; position: relative;" >
...
//                        if(!is_null($item->prod_id))
             ...
             onError="this.onerror=null;this.src='http://www.homebiz365.in/uploads/images/small.png';" />
                ...
                ?>
                                         ...
                                         if($type=="Service") {
                                             ...
                                             ?>">
                                 <b>
                                     <span class="logo-color-b" itemprop="name"><?php 
                                 if($type=="Product") {
                                             echo $item["prod_name"];
                                             }
                                         if($type=="Service") {
        ...
        ?>"
                ...
                ?>
                >
            <p class="text-left text-dark" style="font-size: 12px;" itemscope
             itemtype="http://schema.org/Person" ><span itemprop="name"><?php
                        if($type=="Product") {
                            if($item->prod_unit!="Piece(s)")
                            echo "<b>".$item["prod_qty"]." ".$item["prod_unit"]." - ";
