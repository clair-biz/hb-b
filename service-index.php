...
<div class="">
    ...
    <span class="logo-color-g" style="padding-right: 100px;">
        <b><i class="material-icons blink_text" style="width: 24px; color: #E31E24; ">star_rate</i>&nbsp;Special Introductory Offer! Flat 50% off on Membership Subscription.... Hurry.... Offer valid for limited period only....!!!!&nbsp;<i class="material-icons blink_text" style="width: 24px; color: #E31E24; ">star_rate</i></b>
    </span>
...
<?php require 'service-main-block.php';?>
